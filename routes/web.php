...
Route::get('privmsg/post/{id}.html', 'PrivmsgController@getAnkMess')->whereNumber('id')->name('privmsg.post.id');
Route::get('privmsg/post/delete/{id}.html', 'NoContoller9@index')->whereNumber('id')->name('privmsg.post.delete.id');
