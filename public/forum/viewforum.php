...
$template->assign_vars(array(
	'U_VIEW_FORUM'			=> append_sid("{$phpbb_root_path}forum_" . $forum_id . "_" . $start . ".html"),
));
...
if ($mark_read == 'topics')
{
	...
	$redirect_url = append_sid("{$phpbb_root_path}forum_" . $forum_id . ".html");
...
//	'U_VIEW_FORUM'		=> append_sid("{$phpbb_root_path}viewforum.$phpEx", "f=$forum_id" . ((strlen($u_sort_param)) ? "&amp;$u_sort_param" : '') . "&amp;start=$start"),
	'U_VIEW_FORUM'		=> append_sid("{$phpbb_root_path}forum_" . $forum_id . "_" . $start . ".html" . ((strlen($u_sort_param)) ? "&amp;$u_sort_param" : '')),
...
$template->assign_vars(array(
	'PAGINATION'	=> generate_pagination(append_sid("{$phpbb_root_path}forum_" . $forum_id . ".html", ((strlen($u_sort_param)) ? "&amp;$u_sort_param" : '')), $topics_count, $config['topics_per_page'], $start),
...
//		$view_topic_url = append_sid("{$phpbb_root_path}viewtopic.$phpEx", 'f=' . (($row['forum_id']) ? $row['forum_id'] : $forum_id) . '&amp;t=' . $topic_id);
		$view_topic_url = append_sid("{$phpbb_root_path}topic_" . (($row['forum_id']) ? $row['forum_id'] : $forum_id) . '_' . $topic_id . ".html");
    $view_topic_url_pag = append_sid("{$phpbb_root_path}topic_" . (($row['forum_id']) ? $row['forum_id'] : $forum_id) . '_' . $topic_id . ".html?");
		...
		$template->assign_block_vars('topicrow', array(
			...
			'PAGINATION'		=> topic_generate_pagination($replies, $view_topic_url_pag),
			'REPLIES'			=> $replies,
