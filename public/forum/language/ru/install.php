...
$lang = array_merge($lang, array(
	...
	'COULD_NOT_FIND_PATH'		=> 'Не удалось найти путь к старому форуму. Пожалуйста, проверьте установки и попробуйте снова.<br />» Путь %s был указан как исходный.',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		...
		<p>Нажмите на кнопку ниже, чтобы перейти в администраторский раздел. Уделите некоторое время изучению доступных пунктов меню и настроек. Помните о доступной в интернете <a href="http://www.phpbb.com/support/documentation/3.0/">документации</a> и <a href="http://www.phpbb.com/community/viewforum.php?f=46">форуме техподдержки</a> (на английском) а также официальном форуме русскоязычной поддержки <a href="http://phpbbguru.net">phpBB Guru</a>, за дополнительной информацией обратитесь к <a href="%3$s">README</a>.<br /><br /><strong>Удалите, переместите или переименуйте папку install прежде чем начнёте пользоваться конференцией. В противном случае будет доступен только администраторский раздел.</strong></p>',
	'INSTALL_INTRO'				=> 'Вас приветствует программа установки phpBB',

	'INSTALL_INTRO_BODY'		=> 'Здесь можно установить phpBB3 на ваш сервер.</p><p>Для этого потребуется информация о базе данных. Если вы не знаете её настроек, свяжитесь с вашим хостером. Вы не сможете продолжить установку без этих данных. Вам нужно знать:</p>
	...
	<p>phpBB3 поддерживает следующие типы баз данных:</p>
	<ul>
	...
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>Необходимо</strong> - Для установки phpBB3 требуется версия PHP не младше 4.3.3. Если ниже написано <var>Безопасный режим (Safe mode)</var>, то ваш PHP работает в защищённом режиме. Это наложит ограничения на удаленное администрирование и аналогичные функции.',
	...
	'STAGE_FINAL'				=> 'Заключительный шаг',
...
$lang = array_merge($lang, array(
	...
	'COLLECTED_INFORMATION'			=> 'Сведения о файле',
	...
	'FILES_NOT_MODIFIED_EXPLAIN'	=> 'Следующие файлы не модифицированы и представляют собой оригинальные файлы phpBB той версии, которую вы хотите обновить.',
	...
	'NUMBER_OF_FILES_COLLECTED'		=> 'Проверены различия в %1$d файлах из %2$d.<br />Дождитесь окончания операции.',
	...
	'TRY_DOWNLOAD_METHOD'		=> 'Вы можете попробовать загрузить модифицированные файлы.<br />Этот метод наиболее надёжен и является рекомендуемым способом обновления.',
	'TRY_DOWNLOAD_METHOD_BUTTON'=> 'Попробовать прямо сейчас',
...
$lang = array_merge($lang, array(
	...
	'CONFIG_SITE_DESC'				=> 'Краткое описание конференции',
