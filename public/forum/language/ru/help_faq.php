...
$help = array(
	...
	array(
		...
		1 => 'В настройках личного раздела вы найдете опцию <em>Скрывать моё пребывание на конференции</em>. Выберите <em>Да</em>, и вы будете видны только администраторам, модераторам и самому себе. Для всех остальных вы будете скрытым пользователем.'
	),
	array(
		0 => 'Я забыл пароль!',
		1 => 'Не паникуйте! Хотя пароль нельзя восстановить, можно легко получить новый. Перейдите на страницу входа на конференцию и щелкните на ссылку <em>Забыли пароль?</em>. Следуйте инструкциям, и скоро вы снова сможете войти на конференцию.'
	),
	array(
	...
	array(
		...
		1 => 'Некоторые форумы доступны только определённым пользователям или группам пользователей. Чтобы их просматривать, создавать сообщения и совершать другие действия, вам может потребоваться специальное разрешение. Свяжитесь с модератором или администратором конференции для получения такого разрешения.'
	),
	array(
	...
	array(
		...
		1 => 'Это программное обеспечение (в его исходной форме) создано и распространяется <a href="http://www.phpbb.com/">phpBB Group</a>. Оно доступно на условиях GNU General Public Licence и может свободно распространяться. Для получения более подробных сведений перейдите по приведённой ссылке.'
	),
	array(
		0 => 'Почему здесь нет такой-то функции?',
		1 => 'Это программное обеспечение было создано и лицензировано phpBB Group. Если вы считаете, что какая-то функция должна быть добавлена, то пожалуйста, посетите сайт phpbb.com и узнайте, что по этому поводу думает phpBB Group. Пожалуйста, не оставляйте запросов о добавлении каких-либо функций на конференции phpbb.com, Группа использует SourceForge для работы над новыми функциями. Пожалуйста, сначала просмотрите форумы, чтобы выяснить, каково наше мнение по поводу данной функции (если такое мнение у нас есть) и только после этого следуйте процедуре, которая там будет описана.'
	),
	array(
