...
$lang = array_merge($lang, array(
	...
	'POSTER'					=> 'Автор',
	'POSTS_APPROVED_SUCCESS'	=> 'Выбранные сообщения были одобрены.',
	'POSTS_DELETED_SUCCESS'		=> 'Выбранные сообщения были успешно удалены из базы данных.',
	'POSTS_DISAPPROVED_SUCCESS'	=> 'Выбранные сообщения были отклонены.',
	'POSTS_LOCKED_SUCCESS'		=> 'Выбранные сообщения были успешно закрыты.',
	'POSTS_MERGED_SUCCESS'		=> 'Выбранные сообщения были объединены.',
	'POSTS_UNLOCKED_SUCCESS'	=> 'Выбранные сообщения были успешно открыты.',
	'POSTS_PER_PAGE'			=> 'Сообщений на страницу',
	'POSTS_PER_PAGE_EXPLAIN'	=> '(Установите 0 для просмотра всех сообщений.)',
	'POST_APPROVED_SUCCESS'		=> 'Выбранное сообщение было одобрено.',
	'POST_DELETED_SUCCESS'		=> 'Выбранное сообщение было успешно удалено из базы данных.',
	'POST_DISAPPROVED_SUCCESS'	=> 'Выбранное сообщение было успешно отклонено.',
	'POST_LOCKED_SUCCESS'		=> 'Сообщение успешно заблокировано.',
	'POST_NOT_EXIST'			=> 'Запрошенное вами сообщение не существует.',
	'POST_REPORTED_SUCCESS'		=> 'Жалоба на это сообщение была успешно отправлена.',
	...
	'REPORT_MESSAGE_EXPLAIN'	=> 'Используйте эту форму для отправки жалобы на выбранное сообщение. Жалобы обычно используются только в случаях, когда сообщение нарушает правила форума.',
