...
$lang = array_merge($lang, array(
	'ACP_BBCODES_EXPLAIN'		=> 'BBCode — это специальная реализация HTML, предоставляющая больший контроль над тем, что и как должно быть отображено. С помощью этой страницы вы можете добавлять, удалять и изменять BBCodes.',
	...
	'TOKEN'					=> 'Лексема',
	'TOKENS'				=> 'Лексемы',
	'TOKENS_EXPLAIN'		=> 'Лексемы являются метками-заполнителями для вводимого пользователем содержимого. Правильность введённого содержимого будет подтверждена лишь в случае, если оно отвечает соответствующему определению. Если необходимо, вы можете нумеровать их путём добавления номера в конце лексемы внутри фигурных скобок, непример {TEXT1}, {TEXT2}.<br /><br />В качестве меток-заполнителей вы также можете использовать любую из языковых переменных, присутствующих в вашей языковой папке (language/), например: {L_<em>&lt;STRINGNAME&gt;</em>}, где <em>&lt;STRINGNAME&gt;</em> — это имя переведённой строки, которую вы хотите добавить. Например, {L_WROTE} будет отображено как «wrote» или его перевод в соответствии с языком пользователя.<br /><br /><strong>Учтите, что только лексемы, перечисленные ниже, могут быть использованы в пользовательских BBCodes.</strong>',
...
// Word censors
$lang = array_merge($lang, array(
	'ACP_WORDS_EXPLAIN'		=> 'С помощью этой панели вы можете добавлять, удалять и изменять слова, которые будут автоматически подвергаться цензуре на ваших форумах. Кроме этого, пользователи не смогут зарегистрироваться с именами, содержащими эти слова. В словах могут содержаться подстановочные знаки (*). Например, *тест* будет соответствовать слову «протестировать», тест* — «тестирование», *тест — «протест».',
