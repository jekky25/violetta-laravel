...
$lang = array_merge($lang, array(
	...
	'ACP_ORPHAN_ATTACHMENTS_EXPLAIN'	=> 'Здесь вы можете видеть потерянные файлы. Обычно такие файлы появляются из-за того, что пользователи прикрепляют файлы, но впоследствии не отправляют сообщение. Вы можете удалить такие файлы или прикрепить их к существующим сообщениям. Во втором случае вам потребуется правильный идентификатор сообщения (ID), который вы должны указать самостоятельно. После этого загруженное вложение будет прикреплено к указанному вами сообщению.',
	...
	'SECURE_DOWNLOADS_EXPLAIN'		=> 'С включённой опцией все загрузки будут ограничены указанными вами IP-адресами и узлами.',
	...
	'UPLOAD_DIR_EXPLAIN'			=> 'Папка для хранения вложений. Примечание: если вы измените эту папку, в то время как в ней уже имеются загруженные файлы, то вам придётся вручную скопировать эти файлы в новую папку.',
