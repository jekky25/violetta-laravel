...
$lang = array_merge($lang, array(
	...
	'DELETE_IMAGESET_EXPLAIN'	=> 'Здесь вы можете удалить из базы данных выбранный набор изображений. Кроме того, при наличии прав доступа, вы можете удалить набор изображений с сервера. Пожалуйста, учтите, что отменить удаление невозможно. Удаление набора изображений происходит безвозвратно. Рекомендуется сначала экспортировать набор изображений для возможного использования в будущем.',
	...
	'EDITOR_DISABLED'					=> 'Редактор шаблонов отключен.',
	'EXPORT'							=> 'Экспорт',
	...
	'STYLE_ERR_NO_IDS'			=> 'Вы должны выбрать шаблон, тему и набор рисунков для этого стиля.',
