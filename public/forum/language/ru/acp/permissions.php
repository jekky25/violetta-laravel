...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<h2>Роли</h2>
		<p>Они используются для создания различных типовых наборов прав доступа, чтобы в дальнейшем можно было назначать права, основанные на ролевом доступе. Набор ролей по умолчанию должен целиком удовлетворять потребности администрирования больших и малых конференций, тем не менее, в каждом из четырех разделов вы можете добавлять, изменять и удалять роли так, как считаете целесообразным.</p>

		<h2>Маски прав доступа</h2>
		<p>Маски прав доступа используются для просмотра действующих прав доступа, назначенных для пользователей, модераторов (локальных и супермодераторов), администраторов и форумов.</p>
	...
	'ACP_FORUM_MODERATORS_EXPLAIN'				=> 'Здесь вы можете назначать пользователей и группы пользователей модераторами форумов. Для назначения пользователям прав доступа к форумам, а также для определения прав супермодератора и администратора, используйте соответствующий раздел.',
	...
	'ACP_GLOBAL_MODERATORS_EXPLAIN'				=> 'Здесь вы можете назначать права супермодератора пользователям и группам. Супермодераторы подобны обычным модераторам, за исключением того, что они имеют доступ ко всем форумам конференции.',
	...
	'ROLE_DESCRIPTION_FORUM_FULL'			=> 'Доступ к использованию всех возможностей на форуме, включая создание объявлений и прикреплённых тем. Также доступна возможность игнорирования флуд-интервала.<br />Не рекомендуется для обычных пользователей.',
	...
	'TRACE_USER_FOUNDER'					=> 'Пользователь относится к основателям конференции, поэтому значения администраторских прав установлены <samp>ДА</samp> по умолчанию.',
