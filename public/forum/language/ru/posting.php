...
$lang = array_merge($lang, array(
	...
	'BBCODE_L_HELP'				=> 'Список: [list]text[/list]', 'UBERITE_SSILKI'			=> 'В вашем сообщениие присутствуют гиперссылки<br/>Вы зарегистрированы менее недели назад и не можете публиковать гиперссылки', 
