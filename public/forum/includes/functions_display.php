...
*
* @package phpBB3
* @version $Id: functions_display.php 8987 2008-10-09 14:17:02Z acydburn $
	...
	foreach ($forum_rows as $row)
	{
		...
		if ($row['parent_id'] == $root_data['forum_id'] && $row['forum_type'] == FORUM_CAT)
		{
			$template->assign_block_vars('forumrow', array(
				...
				'U_VIEWFORUM'			=> append_sid("{$phpbb_root_path}forum_" . $row['forum_id'] . ".html"))
			);
		...
		if (isset($subforums[$forum_id]))
		{
			foreach ($subforums[$forum_id] as $subforum_id => $subforum_row)
			{
				...
				{
					$subforums_list[] = array(
						'link'		=> append_sid("{$phpbb_root_path}forum_" . $subforum_id . ".html"),
...
function generate_forum_nav(&$forum_data)
{
	...
	if (!empty($forum_parents))
	{
		foreach ($forum_parents as $parent_forum_id => $parent_data)
		{
			...
			$template->assign_block_vars('navlinks', array(
				...
				'U_VIEW_FORUM'	=> append_sid("{$phpbb_root_path}forum_" . $parent_forum_id . ".html"))
			);
		}
	}
	...
	$template->assign_block_vars('navlinks', array(
		...
		'U_VIEW_FORUM'	=> append_sid("{$phpbb_root_path}forum_" . $forum_data['forum_id'] . ".html"))
	);
...
function display_user_activity(&$userdata)
{
	...
	$template->assign_vars(array(
		...
		'U_ACTIVE_FORUM'		=> append_sid("{$phpbb_root_path}forum_" . $active_f_id . ".html"),
