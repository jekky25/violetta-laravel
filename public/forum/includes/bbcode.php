...
class bbcode
{
			...
			switch ($bbcode_id)
			{
				case 0:
					$this->bbcode_cache[$bbcode_id] = array(
						...
						'preg' => array(
							'#\[quote(?:=&quot;(.*?)&quot;)?:$uid\]((?!\[quote(?:=&quot;.*?&quot;)?:$uid\]).)?#is'	=> "\$this->bbcode_second_pass_quote('\$1', '\$2')"
						)
					);
				break;
	...
	*/
	function bbcode_tpl_replace($tpl_name, $tpl)
	{
		...
		$tpl = preg_replace('/{L_([A-Z_]+)}/', "(!empty(\$user->lang['\$1'])) ? \$user->lang['\$1'] : ucwords(strtolower(str_replace('_', ' ', '\$1')))", $tpl);
