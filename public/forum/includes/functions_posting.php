...
*
* @package phpBB3
* @version $Id: functions_posting.php 9048 2008-11-04 15:54:43Z toonarmy $
...
function load_drafts($topic_id = 0, $forum_id = 0, $id = 0)
{
	...
	foreach ($draft_rows as $draft)
	{
		...
		{
			$link_forum = true;
			$view_url = append_sid("{$phpbb_root_path}forum_" . $draft['forum_id'] . ".html");
		...
		foreach ($msg_list_ary as $email_template => $email_list)
		{
			foreach ($email_list as $addr)
			{
				...
				$messenger->assign_vars(array(
					...
					'U_FORUM'				=> generate_board_url() . "/forum_" . $forum_id . ".html",
