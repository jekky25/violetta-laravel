...
function mcp_move_topic($topic_ids)
{
	...
	else
	{
		...
		$message .= '<br /><br />' . sprintf($user->lang['RETURN_FORUM'], '<a href="' . append_sid("{$phpbb_root_path}forum_" . $forum_id . ".html") . '">', '</a>');
		$message .= '<br /><br />' . sprintf($user->lang['RETURN_NEW_FORUM'], '<a href="' . append_sid("{$phpbb_root_path}forum_" . $to_forum_id . ".html") . '">', '</a>');
...
function mcp_delete_topic($topic_ids)
{
	...
	{
		$redirect = append_sid("{$phpbb_root_path}forum_" . $forum_id . ".html");
...
function mcp_delete_post($post_ids)
{
	...
	if (confirm_box(true))
	{
		...
		$return_link[] = sprintf($user->lang['RETURN_FORUM'], '<a href="' . append_sid("{$phpbb_root_path}forum_" . $forum_id . ".html") . '">', '</a>');
...
function mcp_fork_topic($topic_ids)
{
	...
	else
	{
		...
		{
			$return_link .= '<br /><br />' . sprintf($user->lang['RETURN_NEW_FORUM'], '<a href="' . append_sid("{$phpbb_root_path}forum_" . $to_forum_id . ".html") . '">', '</a>');
		}
